...
const Charsets charsets = {
    Charset{"в”‚", "в”Ђ"},  // LIGHT
    Charset{"в•Џ", "в•Ќ"},  // DASHED
    Charset{"в”ѓ", "в”Ѓ"},  // HEAVY
    Charset{"в•‘", "в•ђ"},  // DOUBLE
    Charset{"в”‚", "в”Ђ"},  // ROUNDED
    Charset{" ", " "},  // EMPTY
};
    ...
    void Render(Screen& screen) override {
      ...
      for (int x = box_.x_min; x <= box_.x_max; ++x) {
        ...
        if (!a_empty && !b_empty) {
          ...
          pixel.character = a_empty ? "в•¶" : "в•ґ";  // NOLINT
    ...
    void Render(Screen& screen) override {
      ...
      for (int y = box_.y_min; y <= box_.y_max; ++y) {
        ...
        if (!a_empty && !b_empty) {
          ...
          pixel.character = a_empty ? "в•·" : "в•µ";  // NOLINT
          pixel.automerge = false;
        }
