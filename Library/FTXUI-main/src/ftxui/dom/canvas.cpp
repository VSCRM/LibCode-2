...
// в”Њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”¬в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”ђ
// в”‚dot1  в”‚ dot4  в”‚
// в”њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”јв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”¤
// в”‚dot2  в”‚ dot5  в”‚
// в”њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”јв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”¤
// в”‚dot3  в”‚ dot6  в”‚
// в”њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”јв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”¤
// в”‚dot0-1в”‚ dot0-2в”‚
// в””в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”ґв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”
...
std::vector<std::string> g_map_block = {
    " ", "в–", "в––", "в–Њ", "в–ќ", "в–Ђ", "в–ћ", "в–›",
    "в–—", "в–љ", "в–„", "в–™", "в–ђ", "в–њ", "в–џ", "в–€",
};

// NOLINTNEXTLINE
const std::map<std::string, uint8_t> g_map_block_inversed = {
    {" ", 0b0000}, {"в–", 0b0001}, {"в––", 0b0010}, {"в–Њ", 0b0011},
    {"в–ќ", 0b0100}, {"в–Ђ", 0b0101}, {"в–ћ", 0b0110}, {"в–›", 0b0111},
    {"в–—", 0b1000}, {"в–љ", 0b1001}, {"в–„", 0b1010}, {"в–™", 0b1011},
    {"в–ђ", 0b1100}, {"в–њ", 0b1101}, {"в–џ", 0b1110}, {"в–€", 0b1111},
};
...
void Canvas::DrawPointOn(int x, int y) {
  ...
  if (cell.type != CellType::kBraille) {
    cell.content.character = "в Ђ";  // 3 bytes.
...
void Canvas::DrawPointOff(int x, int y) {
  ...
  Cell& cell = storage_[XY{x / 2, y / 4}];
  if (cell.type != CellType::kBraille) {
    cell.content.character = "в Ђ";  // 3 byt
    cell.type = CellType::kBraille;
  }
