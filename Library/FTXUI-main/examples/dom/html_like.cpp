  ...
  for (int i = 0;; ++i) {
    auto document =  //
        hflow(
            ...
            paragraph(
                "Le Lorem Ipsum est simplement du faux texte employГ© dans la "
                "composition et la mise en page avant impression. Le Lorem "
                "Ipsum est le faux texte standard de l'imprimerie depuis les "
                "annГ©es 1500, quand un imprimeur anonyme assembla ensemble "
                "des morceaux de texte pour rГ©aliser un livre spГ©cimen de "
                "polices de texte. Il n'a pas fait que survivre cinq siГЁcles, "
                "mais s'est aussi adaptГ© Г  la bureautique informatique, sans "
                "que son contenu n'en soit modifiГ©. Il a Г©tГ© popularisГ© dans "
                "les annГ©es 1960 grГўce Г  la vente de feuilles Letraset "
                "contenant des passages du Lorem Ipsum, et, plus rГ©cemment, "
